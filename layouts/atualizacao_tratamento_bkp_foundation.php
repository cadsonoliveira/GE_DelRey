...
<li>
  ...
  <a href="javascript:;" title="Remover" class="remove ir">Remover</a>
        ...
        <img class="pic" src="'.$cam_img_tratamento.$imagem[0].'" data-caption="'.decodeDate($imagem[1]).'">
			...
			<!--			<li alt="'.$imagem[2].'" id="img'.$i.'">

							<div class="tools">
								<a href="javascript:;" title="Remover" class="remove ir">Remover</a>
								<a href="javascript:;" data-reveal-id="myModal" title="Zoom" class="zoom ir">Zoom</a>
							</div>

                                                      <img class="pic" src="'.$cam_img_tratamento.$imagem[0].'" alt="'.decodeDate($imagem[1]).'"/>

                                                      <div id="myModal" class="reveal-modal">
                                                        <img class="img" src="'.$cam_img_tratamento.$imagem[0].'" alt="'.decodeDate($imagem[1]).'"/>
