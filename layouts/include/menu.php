        ...
        <ul id="menu" class="clearfix">
            ...
            <li id="menuAdjacente">
                <ul>
                    ...
                    <li id="config" class="menuHover"><a <?php echo $class_configuracoes; ?>>CONFIGURAÇÕES</a>
                        <ul class="submenu" style="width:143px;">
                            <li><a class="submenuConfiguracoes" href="especialidades.php">ESPECIALIDADES</a></li>
                            <li><a class="submenuConfiguracoes" href="usuarios.php">USUÁRIOS</a></li>
                        </ul>
                    </li>
                </ul>
            </li>
