...
<?php include_once("include/menu.php") ?>
    <div id="conteudo">
        <div id="dropshadow">
            <div id="breadcrumb">
                <ul>
                    <li><span class="breadcrumbEsquerda"></span><a href="estatisticas.php">estatísticas</a><span class="breadcrumbDireita"></span>
                        <ul>
                            <li><span class="breadcrumbEsquerda bcrumbSelect"></span><h2 class="bcrumbAtivo bcrumbSelect">dados tratamento</h2><span class="breadcrumbDireita bcrumbSelect"></span>
                            </li>
                        </ul>
                    </li>
                </ul>
