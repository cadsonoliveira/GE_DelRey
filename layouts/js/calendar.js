...
var Calendar = new Class({	
  ...
  Implements: Options,
	...
	options: {
		...
		days: ['Domingo', 'Segunda', 'Terça', 'Quarta', 'Quinta', 'Sexta', 'Sábado'], // days of the week starting at sunday
	...
	display: function(cal) {
		...
		for (var i = 1; i < 43; i++) { // 1 to 42 (6 x 7 or 6 weeks)
			...
			if (valid.contains(day)) { // if it's a valid - clickable - day we add interaction
				td.setProperty('title', this.format(date, 'D,d M Y'));
