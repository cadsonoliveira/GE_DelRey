			...
			for($cont = 0; $cont < $qtd_resultado_por_pagina ; $cont++){
				if($linha_registro < $qtd_registros){
					...
					if((isset($_SESSION['PACIENTE']['ID'])) && ($res['id_pessoa'] == $paciente->getId())){
						...
						$inseri_funcao_selecionar = ' onclick="paciente_agenda('.$res['id_pessoa'].');" title="Selecionar paciente para agendamento"';
					};
    ...
    <div id="conteudo">
        ...
        <div id="dropshadow">
            ...
            <div id="container" class="clearfix">
                ...
                <form id="cd_field" action="agenda.php" method="POST" name="cd_field">
        ...
        <script type="text/javascript">
            ...
            function qtdpag(letra){
                if($('resultados_por_pagina').value !=null)
                    location.href = "seleciona_paciente_para_agendamento.php?qtdpag="+$('resultados_por_pagina').value+"&pag="+"<?php $pag_atual ?>"+"&letra="+letra<?php if($chave != ""){echo "+'&chave='+'".$chave."'";} ?>;
            }
        </script>
    </body>
</html>